    ...
    <div class="checkout">
      ...
      <div id="payment" class="payment">
        <div class="card">
          <div class="card-content">
            <svg
              id="logo-visa"
              enable-background="new 0 0 50 70"
              height="70px"
              version="1.1"
              viewBox="0 0 50 50"
              width="70px"
            ...
            <h5>Card Number</h5>
            <h6 id="label-cardnumber">{{userCardnumber}}</h6>
            <h5>
              Expiration
              <span>CVC</span>
            </h5>
        ...
        <div class="card-form">
          ...
          <p class="field space">
            <svg
              ...
              x="0px"
              y="0px"
              viewBox="0 0 191.259 191.259"
              style="enable-background:new 0 0 191.259 191.259;"
              xml:space="preserve"
              width="28px"
              height="28px"
            >
      ...
      <div id="paid" class="paid">
        <svg
          ...
          style="enable-background:new 0 0 310.277 310.277;"
          xml:space="preserve"
          width="180px"
          height="180px"
        >
...
body {
  ...
  background: -moz-linear-gradient(
    ...
    rgba(37, 44, 65, 1) 0%,
    rgba(37, 44, 65, 1) 60%,
    rgba(221, 223, 230, 1) 60%,
    rgba(221, 223, 230, 1) 100%
  );
  background: -webkit-gradient(
    left top,
    left bottom,
    color-stop(0%, rgba(37, 44, 65, 1)),
    color-stop(60%, rgba(37, 44, 65, 1)),
    color-stop(60%, rgba(221, 223, 230, 1)),
    color-stop(100%, rgba(221, 223, 230, 1))
  );
...
.wave:after {
  ...
  background: -moz-linear-gradient(
    top,
    rgba(193, 14, 26, 1) 0%,
    rgba(241, 64, 76, 0.3) 100%
  );
  background: -webkit-gradient(
    left top,
    left bottom,
    color-stop(0%, rgba(193, 14, 26, 1)),
    color-stop(100%, rgba(241, 64, 76, 0.3))
  );
  background: -webkit-linear-gradient(
    top,
    rgba(193, 14, 26, 1) 0%,
